    ...
    private var utilityCommands: [CommandItem] {
        [
            ...
            CommandItem(
                id: "refresh-data",
                title: "Refresh Data",
                subtitle: "Reload all workspaces and sessions",
            ...
            CommandItem(
                ...
                subtitle: "Deselect current workspace and session",
                icon: "xmark.circle",
            ...
            CommandItem(
                ...
                subtitle: "Browse instructions and memory files",
                icon: "brain",
                keywords: ["memory", "copilot", "instructions", "prompts"],
                shortcut: nil,
                action: {
                    selectedRail = .memory
                    isPresented = false
